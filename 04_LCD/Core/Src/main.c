...
int main(void)
{
  ...
  LCD_STM32_SET_CURSOR(5, fila2);
  LCD_STM32_PRINT_CHAR('S');
  ...
  LCD_STM32_SET_CURSOR(2, fila1);
  LCD_STM32_PRINT_STRING("te amo giani");
  ...
  while (1)
  {
	  for(i=0;i<255;i++){
		  ...
		  LCD_STM32_SET_CURSOR(1, fila1);
		  sprintf((char*)i_str,"%03u",i);
