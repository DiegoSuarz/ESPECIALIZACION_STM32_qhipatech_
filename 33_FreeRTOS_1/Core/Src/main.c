...
//  NVIC_SetPriorityGrouping(0);
  ...
  //vTaskPrioritySet(TaskHandle1, tskIDLE_PRIORITY+3); //cambiar la prioridad en tiempo de ejecucion

  //vTaskSuspend(TaskHandle2); //suspender tareas hasta algun evento q to requiera
...
void vTarea1(void *params){
	...
	for(;;){
		...
		vTaskDelay(pdMS_TO_TICKS(300)); //cada un milisegundo
	}
